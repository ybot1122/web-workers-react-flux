...
node_modules/.bin/browserify -t [ babelify --presets [ react ] ] main.js > build/async/bundle.js

cp stores/CurveStore_sequential.js stores/CurveStore.js
node_modules/.bin/browserify -t [ babelify --presets [ react ] ] main.js > build/sequential/bundle.js

cp stores/CurveStore_webworker.js stores/CurveStore.js
node_modules/.bin/browserify -t [ babelify --presets [ react ] ] workers/webworker.js > build/webworker/worker.js
node_modules/.bin/browserify -t [ babelify --presets [ react ] ] main.js > build/webworker/bundle.js
